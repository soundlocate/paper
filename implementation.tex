...
Das Ortungsmodul ist in C++ geschrieben und verwendet \textit{LABPAC}.\todo{citeme}
...
\todo{Jaro: Screenshot mit neuer Software!!!}
\begin{figure}[H]
  \centering
